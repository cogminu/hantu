...
if mode == 'dummy':
    ...
    URL_BASE = URL_BASE_FAKE
elif mode == 'real':
    buy_tr_id = 'JTTT1002U'
    sell_tr_id = 'JTTT1006U'
...
nasd_symbol_list = ["APPL"] # 매수 희망 종목 리스트 (NASD)
...
while True:
    ...
    t_9 = t_now.replace(hour=10, minute=30, second=0, microsecond=0)
    t_start = t_now.replace(hour=10, minute=35, second=0, microsecond=0)
